...
<b>	Follow me on </b>
	<div className="icons">
		...
		<a href="" target="_blank" className="social"><i className="fab fa-medium"></i></a>
		<a href="" target="_blank" className="social"><i className="fab fa-twitter-square"></i></a>
		<a href="" target="_blank" className="social"><i className="fab fa-linkedin"></i></a>
		</div>
	</div>
    </section>
);
