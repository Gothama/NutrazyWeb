...
import Acc from './exerciseAcc.component';
import '../assets/css/timeTable.css'
import Navbar from "./navbar.component";
import Footer from './footer.component';

import image from "../assets/images/tabs-first-icon.png"
import image1 from "../assets/images/line-dec.png"
import image2 from "../assets/images/training-image-01.jpg"
...
return(
    ...
    <div>
        <Navbar/>
    <Header/>
        <section className="class-timetable-section spad" style={{paddingTop:"50px", paddingBottom:"20px"}}>
                ...
                <div className="col-lg-12">
                    <div className="class-timetable">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td className="class-time">Breakfast</td>
                                    <td className="dark-bg hover-bg ts-meta" data-tsmeta="workout">
                                        <h5>WEIGHT LOOSE</h5>
                                        <span>RLefew D. Loee</span>
                                    </td>
                                ...
                                <tr>
                                    <td className="class-time">Lunch</td>
                                    <td className="blank-td"></td>
                                    <td className="dark-bg hover-bg ts-meta" data-tsmeta="fitness">
                                        <h5>Fitness</h5>
                                        <span>Kimberly Stone</span>
                                ...
                                <tr>
                                    <td className="class-time">Dinner</td>
                                    <td className="dark-bg hover-bg ts-meta" data-tsmeta="fitness">
                                        <h5>Boxing</h5>
                                        <span>Rachel Adam</span>
                                    </td>
